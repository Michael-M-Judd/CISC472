...
class michaelTest(ScriptedLoadableModuleTest):
  ...
  def test_michael1(self):
    ...
    #Create a coordinate system model that represents the RAS coordinate system
    ...
    # Create another coordinate system in blue color that will represent the Reference coordinate system.
